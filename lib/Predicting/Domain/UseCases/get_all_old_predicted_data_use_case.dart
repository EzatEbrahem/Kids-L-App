...
class GetAllOldPredictedDataUseCase extends BaseUseCase<List<PredictData>,NoParameters,NoParameters>{
  final BasePredictRepository basePredictRepository;
  GetAllOldPredictedDataUseCase(this.basePredictRepository);
  @override
  Future<Either<Failure, List<PredictData>>> call(NoParameters parameters1,NoParameters  parameters2)async {
   return await basePredictRepository.getAllOldPredictData();
  }
