...
import '../contoller/authentication_state.dart';

class GoogleSignInComponent extends StatelessWidget {
        ...
        builder: (context, state) =>InkWell(
            onTap: () async {
              ...
              if(!isOnline){
                ...
                BlocProvider.of<AuthenticationBloc>(context).add(GoogleSignInAuthenticationEvent());
              }
            }
            ,child: ClipOval(child: Image(image: AssetImage('assets/google-logo.jpg'),width: 40,))),
      ),
    );
  }
}
